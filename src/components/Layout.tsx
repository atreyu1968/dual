...
export const Layout = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      {/* Sidebar */}
      <div className="group bg-[#2A303C] text-gray-300 w-12 hover:w-64 transition-all duration-300 ease-in-out overflow-hidden">
        <div className="flex items-center justify-center h-14 overflow-hidden">
          <span className="text-lg font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            FP Dual
          </span>
        </div>
        <nav className="mt-4">
